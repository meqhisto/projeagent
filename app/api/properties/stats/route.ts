...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Use Promise.all to fetch properties and recentTransactions concurrently
        // Used targeted `select` instead of `include` to avoid over-fetching memory bloat.
        // Removed unused `monthlyTrend` query to reduce database load.
