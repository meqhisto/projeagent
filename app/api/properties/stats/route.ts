...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replace findMany with targeted select and use Promise.all
        // for concurrent database queries, drastically reducing Node.js memory bloat and total database transfer latency.
        const [
            properties,
            recentTransactions,
