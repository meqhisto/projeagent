...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Avoid fetching full properties, units, and transactions into memory.
        // Used targeted 'select' to fetch only the required fields for calculations, reducing DB payload and memory bloat.
