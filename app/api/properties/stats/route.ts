...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Use Promise.all to fetch data concurrently.
        // Replace `include` with targeted `select` to avoid fetching large unused fields (e.g., notes, descriptions) into Node.js memory.
        ...
        // ⚡ Bolt Optimization: Removed `monthlyTrend` query as it was fetched but completely unused in the response payload.
