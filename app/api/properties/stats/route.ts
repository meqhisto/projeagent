...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Use targeted select instead of include to reduce memory bloat
        // and fetch both properties and recentTransactions concurrently using Promise.all
        ...
        // ⚡ Bolt Optimization: Removed unused monthlyTrend database query
