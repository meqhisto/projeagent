...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Use Promise.all for concurrent queries and use targeted select to prevent overfetching.
        const [properties, recentTransactions] = await Promise.all([
            // Get all properties with related data for statistics calculation
