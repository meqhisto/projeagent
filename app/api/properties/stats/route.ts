...
export async function GET() {
    try {
        ...
        // drastically reducing Node.js memory footprint and database payload.
        ...
        // ⚡ Bolt Optimization: Removed completely unused `monthlyTrend` groupBy query
        // that wasted database connections and latency without being returned in the response.
