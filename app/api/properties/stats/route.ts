...
export async function GET() {
    try {
        ...
        // fetching only required fields significantly reduces memory bloat and transfer latency
        ...
        // ⚡ Bolt Optimization: Removed unused `monthlyTrend` query.
        // It performed a complex groupBy on transactions but was never used in the response payload.
