...
export async function GET() {
    try {
        ...
        // Drastically reduces database transfer payload and Node.js memory footprint.
        ...
        // ⚡ Bolt Optimization: Removed unused monthlyTrend query that executed an expensive groupBy
        // but was never included in the final API response.
