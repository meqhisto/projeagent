...
export async function GET() {
    try {
        ...
        // Run queries concurrently and use select to avoid over-fetching
        ...
        // Ensure monthlyTrend is used
        const trendData = monthlyTrend.map(m => ({ type: m.type, total: m._sum.amount }));
        ...
        return NextResponse.json({
            ...
            actualMonthlyRent,
            monthlyTrend: trendData, // Added back to JSON response
