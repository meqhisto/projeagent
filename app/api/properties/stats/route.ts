...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Use Promise.all to fetch both properties and recent transactions concurrently.
        // Replaced include with targeted select to fetch only required fields, preventing massive payload overhead.
        ...
        // ⚡ Bolt Optimization: Safely removed the unused `monthlyTrend` query.
