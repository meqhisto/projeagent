...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replace over-fetching 'include' with targeted 'select'
        // This drastically reduces Node.js memory bloat by only fetching fields used in the stats calculations.
