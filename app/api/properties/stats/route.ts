...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replaced 'include' with targeted 'select' to drastically reduce memory usage.
        // Get only the exact fields required for the portfolio statistics calculations.
        ...
        // ⚡ Bolt Optimization: Removed 'monthlyTrend' database query as the result was completely unused in the API response.
