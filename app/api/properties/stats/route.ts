...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Use Promise.all to fetch properties and transactions concurrently.
        // ⚡ Bolt Optimization: Replaced 'include' with targeted 'select' to prevent over-fetching fields we don't need.
