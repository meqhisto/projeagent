...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Run queries concurrently using Promise.all
        // ⚡ Bolt Optimization: Use targeted select block instead of include true to prevent memory bloat
