...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replace include with select to prevent overfetching full relations
        ...
        // ⚡ Bolt Optimization: Removed unused 'monthlyTrend' database query to save DB overhead.
