...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replaced over-fetching 'include' with targeted 'select' to drastically reduce memory bloat
        // Get all properties with only required fields for statistics
        ...
        // ⚡ Bolt Optimization: Removed unused 'monthlyTrend' database query to eliminate pointless DB load.
