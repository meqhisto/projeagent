...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replaced sequential await calls with Promise.all
        // and used a targeted select instead of full include to reduce memory bloat.
        // monthlyTrend was previously queried but completely unused in the JSON response payload.
        // As Bolt, I have intentionally removed this expensive and unused query entirely.
        const [properties, recentTransactions] = await Promise.all([
            // Get all properties with strictly required related data
