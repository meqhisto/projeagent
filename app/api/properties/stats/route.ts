...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replaced `include` with targeted `select` to prevent overfetching
        // large unneeded fields (like addresses and notes) and full relation objects.
        // This drastically reduces database transfer size and Node.js memory bloat.
