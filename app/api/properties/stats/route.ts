...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replaced include with select to prevent overfetching full objects into memory.
        // Get all properties with related data, fetching only fields necessary for aggregations.
        ...
        // ⚡ Bolt Optimization: Removed monthlyTrend and sixMonthsAgo since its result was never included
        // in the final API response or used downstream, saving an unnecessary database query.
