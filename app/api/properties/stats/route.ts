...
export async function GET() {
    try {
        ...
        // full relational objects (e.g., all unit details, full transactions) for in-memory aggregations.
        // This drastically reduces Node.js memory footprint and database transfer latency.
