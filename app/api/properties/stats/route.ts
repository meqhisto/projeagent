...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replace overfetching include with targeted select
        // Only select fields strictly needed for statistics calculation to minimize DB transfer size and Node.js memory bloat.
        ...
        // ⚡ Bolt Optimization: Removed unused `monthlyTrend` query to eliminate pointless database load
        // as it is completely decoupled from the endpoint's response payload.
