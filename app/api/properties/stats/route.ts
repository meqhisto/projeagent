...
export async function GET() {
    try {
        ...
        // Get all properties with related data, concurrent with other queries
        // ⚡ Bolt Optimization: Used Promise.all to run DB queries concurrently and replaced
        // include block with select to avoid overfetching full models, reducing memory bloat.
