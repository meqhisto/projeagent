    ...
    try {
        ...
        const newProperty = await prisma.property.create({
            data: {
                ...
                balconyCount: balconyCount ? parseInt(balconyCount) : null,
                isFurnished: isFurnished || false,
                monthlyDues: monthlyDues ? parseFloat(monthlyDues) : null,
                hasOccupancyCertificate: hasOccupancyCertificate || false,
                usageType: usageType || null,
                commonAreaRatio: commonAreaRatio ? parseFloat(commonAreaRatio) : null,
