...
export async function GET() {
    try {
        ...
        // ⚡ Bolt: Replaced expensive unpaginated findMany with parallel, optimized Prisma aggregations
        // Expected impact: Drastic reduction in DB transfer overhead and Node.js memory footprint (O(N) -> O(1) DB round-trips).
