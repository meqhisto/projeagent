...
export async function GET() {
    try {
        ...
        // ⚡ Bolt Optimization: Replaced findMany() which overfetched all records.
        // Used Promise.all to run concurrent database aggregations, drastically reducing Node.js memory footprint.
        const [
            totalParcels,
            activeParcels,
            contractParcels,
