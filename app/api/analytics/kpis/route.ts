...
export async function GET() {
    try {
        ...
        // ⚡ BOLT OPTIMIZATION: Push aggregate calculations to DB using Promise.all
        // Replaced expensive findMany() and in-memory reducing with concurrent DB counts
        const [
            totalParcels,
            activeParcels,
            contractParcels,
            ...
            prisma.parcel.count({
                where: { ...baseWhere, crmStage: "CONTRACT" }
            }),
            prisma.parcel.count({
