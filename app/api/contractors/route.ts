...
export async function GET(request: Request) {
    try {
        ...
        // Her firma için ortalama puan hesapla ve kullanılmayan array verilerini (ratings vb.) temizle
        const contractorsWithAvg = contractors.map(c => {
            ...
            // İstemciye ratings array'ini göndermeye gerek yok (_count içerisinden uzunluklarına erişilecek)
