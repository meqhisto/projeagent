                ...
                <div className="relative h-44 w-full overflow-hidden bg-[#f5f5f7]">
                    ...
                    <div className="absolute top-3 right-3 z-10 flex gap-1.5 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-200">
                        <button
                            ...
                            className="p-2 rounded-lg bg-white/90 text-[#6e6e73] hover:text-[#0071e3] shadow-sm transition-colors focus-visible:ring-2 focus-visible:ring-[#0071e3] focus-visible:opacity-100"
                        >
                        ...
                        <button
                            ...
                            className="p-2 rounded-lg bg-white/90 text-[#6e6e73] hover:text-[#ff3b30] shadow-sm transition-colors focus-visible:ring-2 focus-visible:ring-[#ff3b30] focus-visible:opacity-100"
                        >
