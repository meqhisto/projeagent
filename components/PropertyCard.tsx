            ...
            <div className="relative h-44 bg-gray-100">
                ...
                <div className="absolute bottom-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                    <Link
                        ...
                        className="p-2 bg-white/90 rounded-lg hover:bg-[#0071e3] hover:text-white text-gray-600 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-[#0071e3]"
                    ...
                    {onEdit && (
                        <button
                            ...
                            className="p-2 bg-white/90 rounded-lg hover:bg-blue-500 hover:text-white text-gray-600 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-blue-500"
                            aria-label="Düzenle"
                            title="Düzenle"
                        >
                    ...
                    {onDelete && (
                        <button
                            ...
                            className="p-2 bg-white/90 rounded-lg hover:bg-red-500 hover:text-white text-gray-600 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-red-500"
                            aria-label="Sil"
                            title="Sil"
                        >
